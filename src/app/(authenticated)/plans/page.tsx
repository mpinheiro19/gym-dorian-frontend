    ...
    <div>
      ...
      {isLoading ? (
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-800">Loading plans...</p>
        </div>
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mt-auto flex flex-col gap-2">
                <Link
                  href={`/plans/${plan.id}`}
                  className="w-full text-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium"
                >
                  View Plan
                </Link>
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 text-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium hover:bg-gray-50"
                  >
                    Edit
                  </Link>
                  {(plan.status === 'active' ||
                  ...
                  <button
                    ...
                    className="px-3 py-2 border border-red-300 text-red-600 rounded-md text-sm font-medium hover:bg-red-50 disabled:opacity-50"
                  >
                    🗑
                  </button>
                </div>
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <p className="text-gray-600 mb-2">No plans found</p>
