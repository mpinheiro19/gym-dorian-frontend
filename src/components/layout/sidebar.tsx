...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed inset-0 z-40 bg-gray-600/75 hidden" />

      {/* Sidebar */}
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-surface border-r border-border pt-5 pb-4 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-4">
            <h1 className="text-2xl font-bold text-text-primary">Gym Dorian</h1>
          </div>
            ...
            >
              <div className="flex items-center">
                <div className="ml-3">
                  ...
                  <p className="text-xs text-text-tertiary hover:text-text-secondary">
                    {t('signOut')}
                  </p>
                </div>
              </div>
